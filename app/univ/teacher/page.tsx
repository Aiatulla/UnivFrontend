...
const tabContent = {
    ...
    "Categories & Grades": <div><Categories /><Categories /></div>,
    "Grade Distribution": <div>Grade Distribution Content</div>,
    ...
    <div className="flex flex-col md:flex-row">
      ...
      <div className="w-full md:ml-[25%] lg:ml-[16.666667%] p-4 overflow-y-auto">
        <div className="flex flex-col">
                  <Paragraph className="pt-2 text-3xl font-[500]">Teacher Dashboard</Paragraph>
                  <Paragraph type="sm" className="pt-2 text-neutral-500">Welcome back, Dr. Smith. Here's an overview of your subjects.</Paragraph>
                  <Paragraph className="pt-6 font-[500] !text-[24px]" >My Subjects</Paragraph>
                  <div className="flex overflow-x-auto whitespace-nowrap gap-4 scroll-thin pt-2">
                      <SubjectCard />
                      <SubjectCard />
                      <SubjectCard />
                      <SubjectCard />
                  ...
                  <div className="flex flex-col pt-10">
                    <Paragraph className="pt-2 text-3xl font-[500]">CS101 - Introduction to Programming</Paragraph>
                    <Paragraph type="sm" className="pt-2 text-neutral-500">Spring 2023 | Mon/Wed/Fri 10:00-11:30 | Room 205</Paragraph>
